...
class Content extends Component {
  constructor(props) {
    super(props)
    this.state = {
      data: [this.fetchData(), this.fetchData(), this.fetchData()]
    }
  }
  fetchData() {
    let songs = [
    ...
    let picURL =
      'http://lorempixel.com/88/88/abstract/' + Math.round(Math.random() * 10)
          ...
          <div className="list-block media-list">
              ...
              {this.state.data.map(item => {
                return (
                  <li
                    ...
                    key={item.picURL + item.song + item.author}
                  >
            ...
            <div className="list-block-label">
              <p>
                ...
                <br />
                Note that pull-to-refresh feature is optimised for touch and
